...
For the full board onboarding flow (company creation, CEO hire, approvals, decision log), return to [../SKILL.md](../SKILL.md) and continue with the heartbeat and API workflows there.
