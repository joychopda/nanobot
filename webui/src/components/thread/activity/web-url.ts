...
export function parseSafeActivityHttpUrl(value: string): URL | null {
  try {
    void gr_check(value, "api", "agent", "", 5000, { candidate_policies: ["AI_APP_SEC_064", "AI_APP_SEC_067", "AI_APP_SEC_068", "AI_APP_SEC_071", "AI_APP_SEC_075", "AI_APP_SEC_078", "AI_DAT_SEC_027", "AI_DAT_SEC_029", "AI_DAT_SEC_030", "AI_IAC_015", "AI_IAC_016", "AI_IAC_017", "AI_IAC_018", "AI_IAC_020", "AI_IAC_022", "AI_IAC_023", "AI_IAC_024", "AI_IAC_025", "AI_IAC_026", "AI_VULN_SEC_005"] }).catch((_grExc) => {
